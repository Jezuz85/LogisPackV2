<%@ Page Title="Tipo de Facturación" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="index.aspx.vb" Inherits="LogisPack_v1._2.index1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="Server">
	<%: Scripts.Render("~/bundles/TipoFacturacion_Index") %>
</asp:Content>