        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button id="btnAddCerrar" type="button" class="close" data-dismiss="modal" aria-hidden="true">
    ...
    <div id="EditModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button id="btnEditCerrar" type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        <img alt="X" src="../../Content/images/baja.png" /></button>
    ...
    <div id="ViewModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button id="btnViewCerrar" type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        <img alt="X" src="../../Content/images/baja.png" /></button>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="Server">
    <%: Scripts.Render("~/bundles/Almacen_Index") %>
</asp:Content>